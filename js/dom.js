// VARIABEL GLOBAL UNTUK UNREAD BOOK
const INCOMPLETE_BOOK = "incompleteBookshelfList";
// VARIABEL GLOBAL UNTUK ALREADY READ BOOK
...
// FUNGSI MEMBUAT ACTION DELETE
function createActionDelete(idBook) {
  const actionDelete = document.createElement("button");
  actionDelete.classList.add("submit-del");
...
// FUNGSI MEMBUAT ACTION READ
function createActionRead(idBook) {
  const action = document.createElement("button");
  action.classList.add("submit-read");
...
// FUNGSI MEMBUAT ACTION UNDO
function createActionUndo(idBook) {
  const action = document.createElement("button");
  action.classList.add("submit-undo");
